...
module d_fix #(
    ...
    parameter CPU_CLK_DELAY = 7,   // По умолчанию без задержки (0-8)
    // Константа для задержки RAS сигнала (периодов CLK_48MHZ)
    parameter RAS_DELAY = 7,   // По умолчанию без задержки (0-8)
    // Константа для задержки CAS1 сигнала (периодов CLK_48MHZ)
    parameter CAS1_DELAY = 7,  // По умолчанию без задержки (0-8)
    // Константа для задержки CAS2 сигнала (периодов CLK_48MHZ)
    parameter CAS2_DELAY = 7   // По умолчанию без задержки (0-8)
)(
    // Main Clock
    input   CLK_48MHZ,
    // reset
